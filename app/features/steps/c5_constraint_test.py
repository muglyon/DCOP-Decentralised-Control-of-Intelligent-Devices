...
def step_impl(context):
    ...
    assert_that(not context.current_dpop_tested.room.device_list[0].is_in_critic_state, 'device not in critical state')
    assert_that(context.current_dpop_tested.room.device_list[0].end_of_prog > 30, 'device end its program too soon')
