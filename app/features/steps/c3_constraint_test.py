...
def step_impl(context):
    ...
    context.current_dpop_tested.constraint_manager.c5.side_effect = mocked_constraint_return_15
...
def step_impl(context):
    mock_constraints(context)
    context.current_dpop_tested.constraint_manager.c5.side_effect = mocked_constraint_return_241
...
def mock_constraints(context):
    context.current_dpop_tested.constraint_manager.c1 = MagicMock(return_value=0)
    context.current_dpop_tested.constraint_manager.c2 = MagicMock(return_value=0)
    context.current_dpop_tested.constraint_manager.c4 = MagicMock(return_value=0)
    context.current_dpop_tested.constraint_manager.c5 = MagicMock()
